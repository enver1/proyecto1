...
public class pre_index {
    ...
    private void seleccionarSucursal(String ide_sucu) {
        ...
        ale_inicio.setAlertaCeleste("<strong>Bienvenido </strong> al Sistema Adaministración Académica v2.0 <span class='pull-right'> " + utilitario.getFechaLarga(utilitario.getFechaActual()) + " &nbsp;  </span>");
